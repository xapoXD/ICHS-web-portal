...
var CListGroupItem = forwardRef(function (_a, ref) {
    var _b;
    var children = _a.children, active = _a.active, _c = _a.as, as = _c === undefined ? 'li' : _c, className = _a.className, disabled = _a.disabled, color = _a.color, rest = __rest(_a, ["children", "active", "as", "className", "disabled", "color"]);

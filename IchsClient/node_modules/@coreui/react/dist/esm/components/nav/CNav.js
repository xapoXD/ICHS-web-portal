...
var CNav = forwardRef(function (_a, ref) {
    var _b;
    var children = _a.children, _c = _a.as, Component = _c === undefined ? 'ul' : _c, className = _a.className, layout = _a.layout, variant = _a.variant, rest = __rest(_a, ["children", "as", "className", "layout", "variant"]);

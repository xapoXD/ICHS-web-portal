...
var CLink = forwardRef(function (_a, ref) {
    var children = _a.children, active = _a.active, _b = _a.as, Component = _b === undefined ? 'a' : _b, className = _a.className, disabled = _a.disabled, rest = __rest(_a, ["children", "active", "as", "className", "disabled"]);

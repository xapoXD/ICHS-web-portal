...
var CFormFeedback = forwardRef(function (_a, ref) {
    var _b;
    var children = _a.children, _c = _a.as, Component = _c === undefined ? 'div' : _c, className = _a.className, invalid = _a.invalid, tooltip = _a.tooltip, valid = _a.valid, rest = __rest(_a, ["children", "as", "className", "invalid", "tooltip", "valid"]);

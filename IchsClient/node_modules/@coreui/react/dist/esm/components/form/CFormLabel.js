...
var CFormLabel = forwardRef(function (_a, ref) {
    ...
    return (React.createElement("label", __assign({ className: customClassName !== null && customClassName !== undefined ? customClassName : classNames('form-label', className) }, rest, { ref: ref }), children));
});

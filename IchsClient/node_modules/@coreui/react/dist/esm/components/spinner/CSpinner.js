...
var CSpinner = forwardRef(function (_a, ref) {
    var _b;
    var _c = _a.as, Component = _c === undefined ? 'div' : _c, className = _a.className, color = _a.color, size = _a.size, _d = _a.variant, variant = _d === undefined ? 'border' : _d, _e = _a.visuallyHiddenLabel, visuallyHiddenLabel = _e === undefined ? 'Loading...' : _e, rest = __rest(_a, ["as", "className", "color", "size", "variant", "visuallyHiddenLabel"]);

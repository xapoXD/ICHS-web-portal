...
var CCardImage = forwardRef(function (_a, ref) {
    var children = _a.children, _b = _a.as, Component = _b === undefined ? 'img' : _b, className = _a.className, orientation = _a.orientation, rest = __rest(_a, ["children", "as", "className", "orientation"]);

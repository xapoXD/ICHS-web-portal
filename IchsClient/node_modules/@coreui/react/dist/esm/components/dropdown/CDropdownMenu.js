...
var CDropdownMenu = forwardRef(function (_a, ref) {
    var children = _a.children, _b = _a.as, Component = _b === undefined ? 'ul' : _b, className = _a.className, rest = __rest(_a, ["children", "as", "className"]);
    ...
    return (React.createElement(CConditionalPortal, { container: container, portal: portal !== null && portal !== undefined ? portal : false },

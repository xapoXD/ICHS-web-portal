...
var CModal = React.forwardRef(function (_a, ref) {
    var children = _a.children, alignment = _a.alignment, _b = _a.backdrop, backdrop = _b === undefined ? true : _b, className = _a.className, container = _a.container, _c = _a.duration, duration = _c === undefined ? 150 : _c, _d = _a.focus, focus = _d === undefined ? true : _d, fullscreen = _a.fullscreen, _e = _a.keyboard, keyboard = _e === undefined ? true : _e, onClose = _a.onClose, onClosePrevented = _a.onClosePrevented, onShow = _a.onShow, _f = _a.portal, portal = _f === undefined ? true : _f, scrollable = _a.scrollable, size = _a.size, _g = _a.transition, transition = _g === undefined ? true : _g, _h = _a.unmountOnClose, unmountOnClose = _h === undefined ? true : _h, visible = _a.visible, rest = tslib_es6.__rest(_a, ["children", "alignment", "backdrop", "className", "container", "duration", "focus", "fullscreen", "keyboard", "onClose", "onClosePrevented", "onShow", "portal", "scrollable", "size", "transition", "unmountOnClose", "visible"]);

...
var CAccordion = React.forwardRef(function (_a, ref) {
    var children = _a.children, activeItemKey = _a.activeItemKey, _b = _a.alwaysOpen, alwaysOpen = _b === undefined ? false : _b, className = _a.className, flush = _a.flush, rest = tslib_es6.__rest(_a, ["children", "activeItemKey", "alwaysOpen", "className", "flush"]);

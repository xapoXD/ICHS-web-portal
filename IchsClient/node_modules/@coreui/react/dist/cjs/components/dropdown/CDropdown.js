...
var CDropdown = React.forwardRef(function (_a, ref) {
    var _b;
    var children = _a.children, alignment = _a.alignment, _c = _a.as, as = _c === undefined ? 'div' : _c, _d = _a.autoClose, autoClose = _d === undefined ? true : _d, className = _a.className, container = _a.container, dark = _a.dark, direction = _a.direction, _e = _a.offset, offset = _e === undefined ? [0, 2] : _e, onHide = _a.onHide, onShow = _a.onShow, _f = _a.placement, placement = _f === undefined ? 'bottom-start' : _f, _g = _a.popper, popper = _g === undefined ? true : _g, popperConfig = _a.popperConfig, _h = _a.portal, portal = _h === undefined ? false : _h, _j = _a.variant, variant = _j === undefined ? 'btn-group' : _j, _k = _a.visible, visible = _k === undefined ? false : _k, rest = tslib_es6.__rest(_a, ["children", "alignment", "as", "autoClose", "className", "container", "dark", "direction", "offset", "onHide", "onShow", "placement", "popper", "popperConfig", "portal", "variant", "visible"]);

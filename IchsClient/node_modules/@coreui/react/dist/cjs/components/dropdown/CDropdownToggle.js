...
var CDropdownToggle = function (_a) {
    var children = _a.children, _b = _a.caret, caret = _b === undefined ? true : _b, custom = _a.custom, className = _a.className, _c = _a.navLink, navLink = _c === undefined ? true : _c, split = _a.split, _d = _a.trigger, trigger = _d === undefined ? 'click' : _d, rest = tslib_es6.__rest(_a, ["children", "caret", "custom", "className", "navLink", "split", "trigger"]);

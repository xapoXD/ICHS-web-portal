...
var CProgressBar = React.forwardRef(function (_a, ref) {
    var _b;
    var children = _a.children, animated = _a.animated, className = _a.className, color = _a.color, _c = _a.value, value = _c === undefined ? 0 : _c, variant = _a.variant, rest = tslib_es6.__rest(_a, ["children", "animated", "className", "color", "value", "variant"]);

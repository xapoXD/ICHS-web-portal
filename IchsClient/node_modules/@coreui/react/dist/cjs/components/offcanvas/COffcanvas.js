...
var COffcanvas = React.forwardRef(function (_a, ref) {
    var children = _a.children, _b = _a.backdrop, backdrop = _b === undefined ? true : _b, className = _a.className, dark = _a.dark, _c = _a.keyboard, keyboard = _c === undefined ? true : _c, onHide = _a.onHide, onShow = _a.onShow, placement = _a.placement, _d = _a.portal, portal = _d === undefined ? false : _d, _e = _a.responsive, responsive = _e === undefined ? true : _e, _f = _a.scroll, scroll = _f === undefined ? false : _f, _g = _a.visible, visible = _g === undefined ? false : _g, rest = tslib_es6.__rest(_a, ["children", "backdrop", "className", "dark", "keyboard", "onHide", "onShow", "placement", "portal", "responsive", "scroll", "visible"]);
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Transition.default, { in: _visible, nodeRef: offcanvasRef, onEnter: onShow, onEntered: function () { var _a; return (_a = offcanvasRef.current) === null || _a === undefined ? undefined : _a.focus(); }, onExit: onHide, timeout: 300 }, function (state) {
            var _a;

...
var CPopover = React.forwardRef(function (_a, ref) {
    var children = _a.children, _b = _a.animation, animation = _b === undefined ? true : _b, className = _a.className, container = _a.container, content = _a.content, _c = _a.delay, delay = _c === undefined ? 0 : _c, _d = _a.fallbackPlacements, fallbackPlacements = _d === undefined ? ['top', 'right', 'bottom', 'left'] : _d, _e = _a.offset, offset = _e === undefined ? [0, 8] : _e, onHide = _a.onHide, onShow = _a.onShow, _f = _a.placement, placement = _f === undefined ? 'top' : _f, popperConfig = _a.popperConfig, title = _a.title, _g = _a.trigger, trigger = _g === undefined ? 'click' : _g, visible = _a.visible, rest = tslib_es6.__rest(_a, ["children", "animation", "className", "container", "content", "delay", "fallbackPlacements", "offset", "onHide", "onShow", "placement", "popperConfig", "title", "trigger", "visible"]);
